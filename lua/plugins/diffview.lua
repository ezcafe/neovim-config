...
-- show the diagonal lines in place of deleted lines in diff-mode
-- vim.cmd([[
-- 	set fillchars+=diff:╱
-- ]])

-- change layout of diff viewer
-- vim.o.diffopt = 'vertical'

require("diffview").setup({ -- See ':h diffview-config-hooks'
    use_icons = false,
    file_history_panel = {
    ...
    keymaps = {
        ...
        view = {
            ...
            ["<leader>t"] = actions.toggle_files, -- Toggle the files panel.
        },
        file_panel = {
